            ...
            <div class="p-4 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Total Clients</p>
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Total Véhicules</p>
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Total Réservations</p>
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Réservations en Attente</p>
                                <h3 class="text-3xl font-bold"><?php echo $stats['reservations_en_attente']; ?></h3>
                            </div>
                            <div class="icon">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Réservations Approuvées</p>
                                <h3 class="text-3xl font-bold"><?php echo $stats['reservations_approuvees']; ?></h3>
                            </div>
                            <div class="icon">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Réservations Refusées</p>
                                <h3 class="text-3xl font-bold"><?php echo $stats['reservations_refusees']; ?></h3>
                            </div>
                            <div class="icon">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-white/60">Réservations Terminées</p>
                                <h3 class="text-3xl font-bold"><?php echo $stats['reservations_terminee']; ?></h3>
                            </div>
                            <div class="icon">
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold"><?php echo $statsV['vehicules_disponibles']; ?></h3>
                            </div>
                            <div class="icon">
                                <i class="fas fa-car"></i>
                            </div>
                    ...
                    <div class="stat-card">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold"><?php echo $statsV['vehicules_indisponibles']; ?></h3>
                            </div>
                            <div class="icon">
                                <i class="fas fa-car"></i>
                            </div>
