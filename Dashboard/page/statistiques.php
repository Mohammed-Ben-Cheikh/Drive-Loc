            ...
            <div class="p-4 md:p-6">
                ...
                <div class="mb-6 overflow-x-auto custom-scrollbar">
                    ...
                    <div class="flex space-x-4 min-w-max">
                        <button class="flex items-center px-4 py-2 bg-purple-600 rounded-lg hover:bg-purple-700 transition-colors">
                            <i class="fas fa-plus-circle mr-2"></i> New Rental
                        </button>
                        <button class="flex items-center px-4 py-2 bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-colors">
                            <i class="fas fa-car mr-2"></i> Add Vehicle
                        </button>
                        <button class="flex items-center px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6">
                    <div class="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl shadow-xl p-6 backdrop-blur-xl bg-opacity-80">
                        <div class="flex justify-between items-center">
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-orange-600 to-red-600 rounded-xl shadow-xl p-6 backdrop-blur-xl bg-opacity-80">
                        <div class="flex justify-between items-center">
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-pink-600 to-rose-600 rounded-xl shadow-xl p-6 backdrop-blur-xl bg-opacity-80">
                        <div class="flex justify-between items-center">
                            <div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-6">
                    <div class="bg-dark-light rounded-xl shadow-xl p-6 backdrop-blur-xl bg-opacity-80 border border-gray-800">
