        ...
        <section
            ...
            <div class="p-4 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-dark-light rounded-xl overflow-hidden group hover:shadow-xl transition-all duration-300">
                        <div class="relative h-48">
                            <img src="../img/category<?php echo $index % 3 + 1; ?>.jpg" class="w-full h-full object-cover" alt="Category">
                        ...
                        <div class="p-4">
                            <div class="flex justify-between items-start mb-2">
                                <h3 class="text-lg font-semibold">Catégorie #<?php echo $index; ?></h3>
                                <span class="bg-purple-600/20 text-purple-400 px-2 py-1 rounded-lg text-sm">
                                    <?php echo rand(5, 20); ?> véhicules
                                </span>
                            </div>
                            <p class="text-gray-400 text-sm mb-3">Description courte de la catégorie de véhicules...</p>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-gray-400">
                                    <i class="fas fa-car-side mr-2"></i>À partir de <?php echo rand(50, 200); ?>€/jour
                                </span>
