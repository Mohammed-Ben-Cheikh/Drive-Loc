        ...
        <section
            ...
            <div class="p-4 md:p-6">
                ...
                <div class="bg-dark-light rounded-xl p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select
                                class="w-full bg-gray-800 text-white rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-600">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <?php for ($i = 0; $i < 9; $i++): ?>
                        <div
                            class="bg-dark-light rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            <div class="relative">
                                ...
                                <div class="absolute top-4 right-4">
                                    ...
                                    ?>
                                    <span
                                        class="<?php echo $status_classes[$status]; ?> text-white px-3 py-1 rounded-full text-sm font-semibold">
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-2 gap-2 pt-4 border-t border-gray-700">
                                    <button onclick="showReservationDetails(<?php echo $i; ?>)"
                                        class="flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors duration-200">
                                        <i class="fas fa-eye mr-2"></i> Détails
                                    </button>
                                    <button
                                        class="flex items-center justify-center px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-lg transition-colors duration-200">
